 ...
 {
   private static Map<String, String> entityEscapeMap = new HashMap<>();
   private static Map<String, String> escapeEntityMap = new HashMap<>();
   ...
   private static List<String> COMMON_WORDS = new ArrayList<>();
   static {
   ...
   public static String newRandomWord(int length) {
     StringBuffer sb = new StringBuffer();
     for (int i = 0; i < length; i++) {
       char a; int t = newRandomInt(0, 26);
   ...
   public static String newRandomTWID() {
     ...
     String dizhiduiying = ss[n].substring(ss[n].length() - 2, ss[n].length());
   ...
   public static String parseUnicode(String src) {
     ...
     sb.append(src.substring(start, src.length()));
     return sb.toString();
   }
   public static String newRandomPassword(int min, int max) {
     ...
     if (Math.random() > 0.6D && password.length() < max - 4) password = password + newRandomWord(newRandomInt(2, 4)); 
     if (Math.random() > 0.3D && password.length() < max - 4) password = password + newRandomInt(0, 1000); 
     if (password.length() < min) password = password + newRandomPrintableString(min + (max - min) / 2 - password.length()); 
   ...
   public static void main(String[] args) {
     String str1 = new String("adbbda1234");
     String str2 = new String("adbbdf1234sa");
