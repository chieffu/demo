...
@Configuration
@EnableWebSocket
public class DBWebSocketConfig implements WebSocketConfigurer {

    @Autowired
    private DBWebSocketHandler allBetWebSocketHandler;
    @Autowired
    private CustomOriginHandshakeInterceptor customOriginHandshakeInterceptor;

    @Override
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(allBetWebSocketHandler, "/db")
